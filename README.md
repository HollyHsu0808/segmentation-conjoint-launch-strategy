...
Consumer survey of [FILL — n] respondents covering demographics, consumption behaviour and brand attitudes, plus a conjoint exercise across five attributes: flavour, caffeine level, packaging, additives, and price ($3.80–$7.80).
...
- **Segmentation** of survey responses ([FILL — clustering method]) → three segments: Premium-Quality Enthusiasts (32%), Performance-Driven Professionals (12%), Balanced Value Seekers (56%).
...
![Segments](slides/segments.png)
![Perceptual map](slides/perceptual_map.png)
![Product concept](slides/product_concept.png)
